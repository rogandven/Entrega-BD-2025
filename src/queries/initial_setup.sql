...
CREATE TABLE IF NOT EXISTS alumno (
	...
	codigo_curso INT UNSIGNED NOT NULL REFERENCES curso(codigo) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS extraprogramatica (
	...
	hora_fin INT UNSIGNED NOT NULL,
...
CREATE TABLE IF NOT EXISTS especialidad (
	codigo_especialidad INT UNSIGNED NOT NULL PRIMARY KEY REFERENCES especialidad(codigo),
...
CREATE TABLE IF NOT EXISTS media (
	codigo_curso INT UNSIGNED NOT NULL PRIMARY KEY REFERENCES curso(codigo) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS participa (
	...
	codigo INT UNSIGNED NOT NULL PRIMARY KEY REFERENCES extraprogramatica(codigo) ON DELETE CASCADE,
);
...
CREATE TABLE IF NOT EXISTS tiene (
	rut_profesor VARCHAR(15) NOT NULL PRIMARY KEY REFERENCES profesor(rut) ON DELETE CASCADE,
	codigo_especialidad INT UNSIGNED NOT NULL PRIMARY KEY REFERENCES especialidad(codigo) ON DELETE CASCADE
);
