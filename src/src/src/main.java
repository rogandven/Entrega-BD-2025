...
public class main {
        ...
        login.getBtnLogin().addActionListener(e -> {
            try {
                ...
                try {
                    ...
                    d.closeConnection();
                    throw new PrintableException("Parece que hay tablas ya existentes con los mismos nombres.\nEs recomendable eliminarlas.");
                }
                ...
                PrintableException.PrintOtherException(ex);
                login.setVisible(false);
                showSimplifiedDialog(ex.getLocalizedMessage(), "Error!");
                login.setVisible(true);
            } catch (Exception ex) {
                PrintableException.PrintOtherException(ex);
                login.setVisible(false);
                showSimplifiedDialog("Error desconocido.", "Error!");
                login.setVisible(true);
            }
        ...
        try {
            ...
            m.getBtnUpdate().addActionListener(e -> {
                try {
                    ...
                    PrintableException.PrintOtherException(ex);
                    Cursos.showSimplifiedDialog(ex.getMessage(), "Error!");
                } catch (Exception ex) {
                    PrintableException.PrintOtherException(ex);
                    Cursos.showSimplifiedDialog("Error desconocido.", "Error!");
                }
    ...
    public static void initialSetup(Database d) throws PrintableException {
        try {
